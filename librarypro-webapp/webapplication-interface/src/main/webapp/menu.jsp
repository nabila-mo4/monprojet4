      ...
      <ul class="nav navbar-nav">
		...
		<li class="dropdown">
          ...
          <ul class="dropdown-menu" style="background-color:#333; border-top:3px solid #007bff; min-width:200px;">
             ...
             <s:url action="logintest.action" var="login"/>
            <li><a href="<s:property value="#login" />" style="color:#007bff; padding:6px 20px; -webkit-transition:padding 0.5s ease; -moz-transition:padding 0.5s ease; -o-transition:padding 0.5s ease; transition:padding 0.5s ease;">Se connecter</a></li>
